...
export default function BridalParty({ register, watch, errors, onNext, onBack, setValue, dayNumber }) {
  ...
  const hasAirbrush = getData("has_party_airbrush") === "Yes";
  const party_airbrush_count = Number(getData("party_airbrush_count") || 0);
